...
function EditInfractionModal({ isOpen, onClose, infraction, onEditInfraction }) {
      ...
      if (response.ok) {
        ...
        if (response.status === 403) {
          await Swal.fire({
            icon: 'error',
            title: 'Accès refusé',
            text: 'Vous n\'avez pas les permissions nécessaires pour modifier une infraction.',
            confirmButtonColor: '#111827',
          });
          setLoading(false);
          return;
        ...
        const errorMessage = errorData.message || 'Erreur lors de la modification de l\'infraction';
  ...
  if (!isOpen || !infraction) return null;
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        <div className="relative bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200">
            <h2 className="text-2xl font-bold text-gray-900">Modifier l'infraction</h2>
            <button
              onClick={handleClose}
